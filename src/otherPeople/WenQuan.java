...
public class WenQuan extends TablutPlayer {
    ...
    // Find out what was the opponent's last move.
    ...
    public float eval(TablutBoardState bs) {
     ...
     // Start by counting how many pieces each player has.
        ...
        score = score + 10*(myPieces - urPieces*0.7f);   
        if (myPieces - urPieces > 10) score += urPieces*3;
        return score;
    }
